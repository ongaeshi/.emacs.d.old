...
;; $Id: pukiwiki-mode.el,v 2.26 2004/11/14 02:01:38 akihisa Exp $
;;
...
If you want to set up your own key bindings, use `pukiwiki-edit-mode-hook'."
  ...
  (define-key pukiwiki-edit-mode-map "\C-x\C-s" 'pukiwiki-edit-save-buffer)
  )
...
(defvar pukiwiki-edit-save-buffer-dir nil
  "pukiwiki-edit-save-buffer時にファイルを保存するディレクトリ")

(defun pukiwiki-edit-save-buffer ()
  "現在編集中のバッファを、pukiwiki-edit-save-buffer-dirで指定されたディレクトリに保存する。
pukiwiki-edit-save-buffer-dirがnilの場合は何もしない。"
  (interactive)
  (let ((filename (buffer-name)))
	...
	(while (string-match "/" filename)
      ...
      (if pukiwiki-edit-save-buffer-dir
	  (write-file (concat pukiwiki-edit-save-buffer-dir "/" filename))
	(message "pukiwiki-edit-save-buffer-dir is nil")))
      ))
